...
**dplyr** is a popular library for *data wrangling*. There are also convenient [data wrangling cheatsheets](https://rstudio.github.io/cheatsheets/) to help you get started (dplyr, tidyr etc.)
...
Hint:
- See the previous exercise for help on how to select columns
...
The **dplyr** library has a `rename()` function, which can also be used. Remember [the cheatsheets](https://rstudio.github.io/cheatsheets/).
...
There is also a [cheatsheet](https://rstudio.github.io/cheatsheets/) for data visualization with ggplot2.
